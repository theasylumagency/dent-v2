...
**ადმინისტრირება**
14. პარამეტრები
15. პრობლემების სწრაფი მოგვარება
...
> **ეს არ არის ის ფოსტა, სადაც ჩაწერის შეტყობინებები მოდის.** ეს საჯარო მისამართია, რომელსაც პაციენტი ხედავს. შეტყობინებების მისამართი ცალკე პარამეტრია — იხილე თავი 14.
...
**ორივე ცარიელი დატოვე და Google აიღებს ზემოთ დაწერილ სათაურსა და მოკლე აღწერას — უმეტეს შემთხვევაში სწორედ ესაა საჭირო.** შეავსე მხოლოდ მაშინ, თუ სათაური გვერდზე კარგად იკითხება, ძებნის სიაში კი — არა.
...
კლინიკის გუნდი. ექიმები ჩანს მთავარ გვერდზე და „ჩვენს შესახებ“ გვერდზე.
...
**„საიტზე გამოჩნდეს“ გამორთული** ნიშნავს, რომ გვერდი წერს „პროფილი მზადდება“ — ცარიელი სათაურების ნაცვლად. სანამ ექიმის მონაცემები დაზუსტებულია, ეს გამორთული დატოვე.
...
**მისამართი** არის ღუზა „ჩვენს შესახებ“ გვერდზე: `/ka/about#archil-apkhadze`. არსებული მისამართი არასდროს გადაიწერება.
...
**ბიოგრაფია** — ორ-სამი აბზაცი. ეს არის ის, რასაც პაციენტი ექიმის შესახებ წაიკითხავს.
...
ეს ის ტექსტია, რომელიც Google-სა და სოციალურ ქსელებში გაზიარებისას ჩანს.
...
ორივე ითარგმნება — სამივე ენაზე ცალ-ცალკე.
...
## რატომ არ არის აქ სერვისები და აპარატურა

ცალკე სერვისი და ცალკე აპარატი **გვერდი არ არის** — ისინი მიმართულების ან ტექნოლოგიების გვერდზე ღუზად ჩნდება. ამიტომ მათი ცალკე სათაურისთვის ადგილი უბრალოდ არ არსებობს.

სიახლეებს კი **საკუთარი** Google-ის ველები აქვთ — თითოეულ სტატიაში, თავად სტატიის შიგნით. იხილე თავი 5.
...
|---|---|---|
| **სიახლეები** | სათაური, მოკლე აღწერა, ტექსტი, Google-ის ორივე ველი | მისამართი, კატეგორია, თარიღი, მთავარი სურათი |
| **სერვისები** | დასახელება, ერთი წინადადება, შესავალი, რას მოიცავს | მისამართი, მიმართულება, რიგითობა |
| **ექიმები** | სახელი, პოზიცია, სპეციალიზაცია, თეგები, ბიოგრაფია, განათლება, გამოცდილება, ტრენინგები, ენები | ფოტო, მისამართი, რიგითობა, ორივე ჩექბოქსი, გამოცდილების წლები |
...
| **Google-ის ტექსტები** | სათაური, აღწერა — ყველა გვერდზე | — |
| **ლენდინგ გვერდები** | თითქმის ყველა ტექსტი | სტატუსი, მისამართი, თარიღები, ჩექბოქსები, სურათები |

---

*ვერსია 1.0 · შედგენილია ადმინისტრაციული პანელის კოდის მიხედვით*
