...
/**
 * Server-facing boundary for the homepage technology section (the light,
 * stepped "precision rail"). The scroll logic stays in a small client
 * island; localized copy and the route are prepared here so the rest of the
