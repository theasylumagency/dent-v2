...
export const media = {
   ...
   *
   * Each crop has a WebM and MP4 encode. `HeroMedia` selects WebM when the
   * browser reports support and retains MP4 as the universal fallback.
   *
  ...
  heroVideo: {
    wide: {
      webm: "/media/hero_video_16_9.webm",
      mp4: "/media/hero_video_16_9.mp4",
    },
    tall: {
      webm: "/media/hero_video_9_16.webm",
      mp4: "/media/hero_video_9_16.mp4",
    },
  },
