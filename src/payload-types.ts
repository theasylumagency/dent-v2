...
export interface User {
  ...
  name: string;
  /**
   * ადმინისტრატორი ანგარიშებს მართავს. რედაქტორი საიტის შიგთავსს ცვლის. კლინიკის ადმინისტრატორი ხედავს მხოლოდ ჩაწერის მოთხოვნებს და ცვლის მათ სტატუსს.
   */
  role: 'admin' | 'editor' | 'clinic-admin';
  updatedAt: string;
  createdAt: string;
  email: string;
